...
public _LibTFC_Misc_GetClassDefaultWeaponFlags(iPlugin, iParams)
{
	...
	switch(class)
	{
		case TFC_CLASS_SCOUT:		return TFC_WPNFLAG_CROWBAR | TFC_WPNFLAG_SHOTGUN | TFC_WPNFLAG_NAILGUN;
		case TFC_CLASS_SNIPER:		return TFC_WPNFLAG_CROWBAR | TFC_WPNFLAG_SNIPER_RIFLE | TFC_WPNFLAG_AUTO_RIFLE | TFC_WPNFLAG_NAILGUN;
		case TFC_CLASS_SOLDIER:		return TFC_WPNFLAG_CROWBAR | TFC_WPNFLAG_SHOTGUN | TFC_WPNFLAG_SUPER_SHOTGUN | TFC_WPNFLAG_ROCKET_LAUNCHER;
		case TFC_CLASS_DEMOMAN:		return TFC_WPNFLAG_CROWBAR | TFC_WPNFLAG_SHOTGUN | TFC_WPNFLAG_GRENADE_LAUNCHER | TFC_WPNFLAG_DETPACK;
		...
		case TFC_CLASS_HWGUY:		return TFC_WPNFLAG_CROWBAR | TFC_WPNFLAG_SHOTGUN | TFC_WPNFLAG_SUPER_SHOTGUN | TFC_WPNFLAG_ASSAULT_CANNON;
		case TFC_CLASS_PYRO:		return TFC_WPNFLAG_CROWBAR | TFC_WPNFLAG_SHOTGUN | TFC_WPNFLAG_FLAMETHROWER | TFC_WPNFLAG_INCENDIARY;
		case TFC_CLASS_SPY:			return TFC_WPNFLAG_CROWBAR | TFC_WPNFLAG_SUPER_SHOTGUN | TFC_WPNFLAG_NAILGUN | TFC_WPNFLAG_TRANQ;
		case TFC_CLASS_ENGINEER:	return TFC_WPNFLAG_SPANNER | TFC_WPNFLAG_SUPER_SHOTGUN | TFC_WPNFLAG_RAILGUN;
		case TFC_CLASS_CIVILIAN:	return TFC_WPNFLAG_CROWBAR;
	}
